...
@Injectable()
export class RelacionFechaTipodiaPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.relacionFechaTipodiaModalRef(component, new RelacionFechaTipodia());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    relacionFechaTipodiaModalRef(component: Component, relacionFechaTipodia: RelacionFechaTipodia): NgbModalRef {
        const modalRef = this.modalService.open(component, { size: 'lg', backdrop: 'static'});
        modalRef.componentInstance.relacionFechaTipodia = relacionFechaTipodia;

...
describe('Service Tests', () => {
    ...
    describe('RelacionFechaTipodia Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RelacionFechaTipodiaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/relacion-fecha-tipodias';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RelacionFechaTipodia', () => {
